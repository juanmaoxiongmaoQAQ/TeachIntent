          ...
          <div className="mt-3 space-y-3">
            {adapter.unsupported_controls.length ? (
              adapter.unsupported_controls.map((control) => (
                <div key={control.path} className="rounded-xl bg-slate-50 p-3">
                  <div className="flex gap-2">
                    <Circle className="mt-1 h-3.5 w-3.5 shrink-0 text-slate-400" />
                    <div>
                      <p className="font-mono text-xs text-slate-600">
                        {control.path}
                      </p>
                      ...
                      <p className="mt-1 text-xs leading-5 text-slate-600">
                        Preserved in Speech Plan; not realized by current
                        adapter.
                      </p>
