...
|---:|---|---|---|---|
| 1 | Runnable Hy3-based AI application for a real open-ended scenario | Hy3 plans a context-sensitive AI-tutor turn from a validated input; offline/live terminal and single-page visual modes are provided. | [`README.md`](../README.md), [`scripts/run_demo.py`](../scripts/run_demo.py), [`scripts/run_visual_demo.py`](../scripts/run_visual_demo.py), [`src/teachintent/generator/`](../src/teachintent/generator/) | **DONE** |
...
| 10 | <=2 minute demo video or GIF | Exact visual/audio screen sequence and narration are prepared; the media file itself is not recorded in the repository. | [`DEMO_SCRIPT.md`](DEMO_SCRIPT.md), [`scripts/run_visual_demo.py`](../scripts/run_visual_demo.py), [`TTS_RENDERER.md`](TTS_RENDERER.md) | **NEEDS MANUAL ACTION** |
